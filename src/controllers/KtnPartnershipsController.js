class KtnPartnershipsController {
  constructor({ ktnPartnershipsService, responseHandler }) {
    this.service = ktnPartnershipsService;
...
module.exports = KtnPartnershipsController;
