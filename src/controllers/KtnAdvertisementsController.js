class KtnAdvertisementsController {
  constructor({ ktnAdvertisementsService, responseHandler }) {
    this.service = ktnAdvertisementsService;
...
module.exports = KtnAdvertisementsController;
